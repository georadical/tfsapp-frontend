...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TimesheetApi.TimesheetEntry();
  });
  ...
  describe('TimesheetEntry', function() {
    it('should create an instance of TimesheetEntry', function() {
      // uncomment below and update the code to test TimesheetEntry
      //var instance = new TimesheetApi.TimesheetEntry();
      //expect(instance).to.be.a(TimesheetApi.TimesheetEntry);
    });
    ...
    it('should have the property rateApplied (base name: "rate_applied")', function() {
      // uncomment below and update the code to test the property rateApplied
      //var instance = new TimesheetApi.TimesheetEntry();
      //expect(instance).to.be();
    });
