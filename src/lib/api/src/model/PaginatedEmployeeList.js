...
class PaginatedEmployeeList {
    ...
    constructor(count, results) { 
        ...
        PaginatedEmployeeList.initialize(this, count, results);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaginatedEmployeeList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaginatedEmployeeList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaginatedEmployeeList.RequiredProperties) {
...
PaginatedEmployeeList.RequiredProperties = ["count", "results"];

/**
 * @member {Number} count
 */
PaginatedEmployeeList.prototype['count'] = undefined;
